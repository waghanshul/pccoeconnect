...
const Landing = () => {
  const [step, setStep] = useState<"initial" | "auth">("initial");
              ...
              <div className="w-full max-w-md mx-auto space-y-8">
                ...
                <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15, duration: 0.35 }} className="text-center space-y-4">
                  <h2 className="text-3xl font-semibold">
                    Sign in to <span className="gradient-text">ChatPCCOE</span>
                  </h2>
                  <p className="text-muted-foreground">
                    Students and professors — enter your credentials to continue
                  </p>
                </motion.div>
